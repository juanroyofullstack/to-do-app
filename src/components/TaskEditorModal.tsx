...
export const TaskEditorModal = (): JSX.Element => {
    ...
    return(
        <div className='TaskEditorModal flex absolute items-center justify-center w-full h-full'>
            <form onSubmit={handleModifyTask} className="flex justify-center flex-col rounded-md z-10 gap-4 border-gray-200 border-4 bg-white p-32 w-6/12 h-2/4">
                ...
                <input defaultValue={taskData.body} name="body" onChange={handleChange} className=" border-4 rounded-md border-blue-200 w-full"></input>
            ...
            <div className="absolute bg-gray-500 opacity-50 z-0 h-full w-full"></div>
        </div>);
};
